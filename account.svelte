...
<div class="container">
  ...
  <form action="cuenta">
    <div class="row justify-content-center">
      ...
      <div class="col-md-7 col-xs-12">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="razon-social" value="Juan" aria-label="razon-social" aria-describedby="basic-addon1" disabled>
        </div>
        <!-- <input
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-7 col-xs-12">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="nombre-fantasia" value="Juan" aria-label="nombre-fantasia" aria-describedby="basic-addon1" disabled>
        </div>
        <!-- <input
      ...
      <div class="input-group col-md-7 mb-3">
        <input type="text" class="form-control" name="rut" value="26.806112-4" aria-label="rut" aria-describedby="basic-addon1" disabled>
      </div>
      <!-- <div class="col-7">
        <input
          class="long-input"
    ...
    <div class="row justify-content-center ">
      ...
      <div class="input-group col-md-4 col-xs-5 mb-3">
        <input type="text" class="form-control" name="rut" value="26.806112-4" aria-label="rut" aria-describedby="basic-addon1">
      </div>
      <div class="input-group col-md-3 col-xs-5 mb-3">
        <input type="text" class="form-control" name="rut" value="26.806112-4" aria-label="rut" aria-describedby="basic-addon1">
      </div>
    </div>
    <div class="row justify-content-center ">
      <div class="col-md-3">
        <label class="subtitle" for="email">Correos:</label>
      </div>
      <div class="input-group col-md-4 col-xs-5 mb-3">
        <input type="text" class="form-control" name="email" value="juan.john@gmail.com" aria-label="email" aria-describedby="basic-addon1">
      </div>
      <div class="input-group col-md-3 col-xs-5 mb-3">
        <input type="text" class="form-control" name="confirmar" value="juan.john@gmail.com" aria-label="confirmar" aria-describedby="basic-addon1">
      </div>
    </div>
  </form>
  <br />
  <div class="row justify-content-center locales-tbl">
